    ...
    if (buttonIndex == 0)
    {
        ...
        if (__iOS7)
        {
          //  [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent animated:YES];
            ...
            appDelegate.window.tintColor = kColorForeground;
        }
...
- (void)viewDidLoad {
    ...
    btnRefresh = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, kBarItemWidth, kBarItemHeight)];
