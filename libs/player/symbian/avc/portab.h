...
#if defined(__GNUC__) && defined(__cplusplus) &&!defined(TARGET_SYMBIAN)
...
int wcsncmp(const tchar_t *,const tchar_t *,size_t);
tchar_t* wcschr(const tchar_t *, tchar_t);
tchar_t* wcsrchr(const tchar_t *, tchar_t);
void* memcpy_sy(void* dst, const void* src, size_t size);
void* memmove_sy(void* dst, const void* src, size_t size);
void* memset_sy(void* dst, int len, size_t count);
void* memchr_sy(const void* buf, int c, size_t count);
int memcmp_sy(const void* dst, const void* src, size_t count);
void* malloc_sy(size_t n);
void* realloc_sy(void* p, size_t n);
void free_sy(void* p);
