...
- (void)show
{
	...
	[navItem setRightBarButtonItem:[[[UIBarButtonItem alloc] initWithTitle:@"Login" style:UIBarButtonItemStyleBordered target:self action:@selector(loginWithCredentialsFromDialog:)] autorelease]];
