...
class ColorConvertBase
{
    public:
        ...
        */
		...
		/**
        *   @brief This function allows the Source pitch to be set at run-time,
        *   @return 1.
        */
        int32 SetSrcPitch(int32 iSrcPitch)
        {
            _mDisp.src_pitch = _mSrc_pitch = iSrcPitch;
            return 1;
        };
        ...
        */
        ...
        {
            _mDisp.dst_pitch = _mDst_pitch = iDstPitch;
            return 1;
        };
