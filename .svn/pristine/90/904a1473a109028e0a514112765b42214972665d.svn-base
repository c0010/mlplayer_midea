...
#define XMPPLogTrace2(frmt, ...)


#define XMPPLogCError(frmt, ...)

#define XMPPLogCWarn(frmt, ...)

#define XMPPLogCInfo(frmt, ...)

#define XMPPLogCVerbose(frmt, ...)

#define XMPPLogCTrace()

#define XMPPLogCTrace2(frmt, ...)
#endif
