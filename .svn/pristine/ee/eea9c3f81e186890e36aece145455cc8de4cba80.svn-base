...
//  
//  FileName: 
//  Description: aac格式网络播放数据处理类
//  Author: Tim
// //////////////////////////////////////////////////////////////////////////////
#ifndef CMAACDATASOURCE_H_HEADER_INCLUDED_B5B55C04
#define CMAACDATASOURCE_H_HEADER_INCLUDED_B5B55C04
...
//网路数据处理
class CMAACDataSource : public IMNotifyHttpC, public IMNotifyTimer, public IMDataInter
{
  public:

	    CMAACDataSource();
		virtual ~CMAACDataSource();
        ...
        virtual BOOL Open(const CMList<CMString>& playlist, EMediaType mtype); //打开playlist
...
#endif /* CMAACDATASOURCE_H_HEADER_INCLUDED_B5B55C04 */
